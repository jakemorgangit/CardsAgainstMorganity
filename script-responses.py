...
try:
    image = Image.open('./background-white.png')
...
def draw_text(text):    
    ...
    img = Image.open('./background-white.png')
...
fileObj = open("./responses.txt", "r", encoding='utf-8')
...
#text = "A man in yoga pants with a ponytail and feather earings."
	...
	color = 'rgb(0,0,0)'  # Main text color
	x = 20
	y = 20
	...
	rmg.save(tempfile.mkstemp('.png', 'response', './responses')[1])
